...
| 3 | Каталог | 80 плагинов / 1743 версий, рецепты; собирать самому [SF 16] | bufbuild/plugins: 85 / 1886, готовые [команда: gh api tree, 2026-09-23]; кол-во на buf.build/plugins — [не подтверждено] | **BSR** немного больше и не требует сборки. Приватные: EasyP — на любом тарифе (Community ≤10 версий всего) [SF 8.1]; BSR — Pro+ [док Buf: custom-plugins]. |
