...
| `easyp validate-config` | Проверка v1-политики, конфигурации генератора, манифеста или lock-файла |
| `easyp ls-files` | Список локальных proto и достижимых импортов |
| `easyp schema-gen` | Генерация JSON Schema для v1 |
| `easyp completion bash\|zsh` | Вывод скрипта автодополнения |
