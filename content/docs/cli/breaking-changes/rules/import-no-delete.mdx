...
import "google/protobuf/timestamp.proto";
// import "google/protobuf/duration.proto"; // Deleted import - BREAKING!
// import "common/user.proto"; // Deleted import - BREAKING!
// import "common/address.proto"; // Deleted import - BREAKING!
...
import "google/protobuf/timestamp.proto";
import "google/protobuf/duration.proto"; // Keep even if unused
import "common/user.proto"; // Keep even if unused
import "common/address.proto"; // Keep even if unused
...
import "google/protobuf/timestamp.proto";
import "google/protobuf/duration.proto"; // Keep original import
import "common/user.proto"; // Keep original import
import "common/address.proto"; // Keep original import
import "common/v2/user.proto"; // Add new import

message Order {
  string id = 1;
  google.protobuf.Timestamp created_at = 2;
  google.protobuf.Duration processing_time = 3 [deprecated = true]; // Keep old field
  common.User customer = 4 [deprecated = true]; // Keep old field
  common.Address shipping_address = 5 [deprecated = true]; // Keep old field
  
  int32 processing_seconds = 6; // New field instead of Duration
  common.v2.UserProfile customer_v2 = 7; // New field with updated type
  string shipping_address_text = 8; // New field with simpler type
}
```
