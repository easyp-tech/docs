...
message User {
  string name = 1;
  optional string email = 2; // Changed from required to optional
  int32 age = 3;
}

message CreateUserRequest {
  string name = 1;
  string email = 2; // Changed from optional to required
  string phone = 3;
}
```
...
message User {
  string name = 1;
  string email = 2 [deprecated = true]; // Keep original cardinality
  int32 age = 3;
  optional string email_optional = 4; // New field with desired cardinality
}

message CreateUserRequest {
  string name = 1;
  optional string email = 2 [deprecated = true]; // Keep original cardinality
  string phone = 3;
  string email_required = 4; // New field with desired cardinality
}
```
...
message User {
  string name = 1;
  optional string email = 2; // Clean cardinality in v2
  int32 age = 3;
}

message CreateUserRequest {
  string name = 1;
  string email = 2; // Required in v2
  string phone = 3;
}
```
