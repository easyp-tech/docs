...
enum OrderStatus {
  ORDER_STATUS_UNSPECIFIED = 0;
  ORDER_STATUS_PENDING = 1;
  ORDER_STATUS_APPROVED = 2; // Changed from ORDER_STATUS_CONFIRMED
  ORDER_STATUS_SHIPPED = 3;
  ORDER_STATUS_COMPLETED = 4; // Changed from ORDER_STATUS_DELIVERED
}
```
...
enum OrderStatus {
  ...
  ORDER_STATUS_SHIPPED = 3;
  ORDER_STATUS_DELIVERED = 4 [deprecated = true];
  ORDER_STATUS_APPROVED = 5; // New value instead of renaming
  ORDER_STATUS_COMPLETED = 6; // New value instead of renaming
}
```
...
enum OrderStatus {
  ORDER_STATUS_UNSPECIFIED = 0;
  ORDER_STATUS_PENDING = 1;
  ORDER_STATUS_APPROVED = 2; // Clean names in v2
  ORDER_STATUS_SHIPPED = 3;
